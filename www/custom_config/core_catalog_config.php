 ...
 */
    ...
    $CustomCatalogIDArray1=array(77,328,329,442,459,461,464,465,467,473,474,475,476,477,478,479,480,481,482,483,484,485,486,487,488,489,490,491,492,493,494,495,496,497,498,499,500,501,502,504,507,508,509,536,538,543,545,549,551,555,562,581,585,586,591,594,595,615,527,637,638,639);
/* 
 ...
 */
    $CustomCatalogIDArray2=array(5,9,16,18,30,31,32,33,34,35,36,37,38,44,60,62,77,81,85,88,96,97,98,99,120,121,122,123,134,141,142,143,154,172,186,190,191,201,211,215,224,227,228,234,247,248,249,254,252,256,257,258,272,288,290,292,293,295,297,298,299,300,332,333,334,335,336,337,350,351,352,353,354,355,356,382,414,415,416,418,419,420,421,422,423,424,425,436,437,440,472,473,474,475,476,477,478,479,480,481,482,483,484,485,486,487,488,489,490,491,492,493,494,495,496,497,498,499,500,501,502,536,545,585,527,328,329,504,503,615,637,638,639,677,690,691,692);
/* 
 *$CustomCatalogIDArray2_2-запролняется в случае каталогов, для которых требуется кастомизированный вывод в одну строку. 
 * Борис: также заполняется для "виртуальных" каталогов, в которых физически не лежат товары (пример - каталог 442), при этом вывод идет 3 товара в строку
 */

    $CustomCatalogIDArray2_2=array(30,31,32,33,34,35,77,81,96,121,141,154,186,190,191,201,227,328,329,333,334,382,414,415,416,418,419,420,421,422,423,424,425,431,432,436,433,437,440,442,459,461,464,465,467,472,473,474,475,476,477,478,479,480,481,482,483,484,485,486,487,488,489,490,491,492,493,494,495,496,497,498,499,500,501,502,504,507,508,527,536,538,543,545,549,551,555,562,581,585,586,591,594,595,615,637,638,639);
 ...
 */
    function buildwheresql($id,$source=1,$category=0){
        $where='';
        switch (intval($id)) {
		case 442: $where=' where id in (443,622)';
                          break;  		
                ...
                case 595: $where = " where id in (600,601)";
                          break;
                case 615: $where = " where id in (49,594)";
                          break;
                case 527: $where=' where id in (617,619,618,616)';
                          break;
                case 328: $where=' where id in (623)';
                          break;
                case 329: $where=' where id in (625)';
                          break;
                case 504: $where=' where id in (627,626,628)';
                          break;
                case 507: $where=' where id in (630,629,631)';
                          break;
                case 508: $where=' where id in (632,633)';
                          break;
                case 77: $where=' where id in (634)';
                          break;    
		case 637: $where=' where id in (38,120,62)';
                          break;
		case 639: $where=' where id in (41,40)';
                          break;
                case 638: $where=' where id in (314,45)';
		          break;
