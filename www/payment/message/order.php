...
// Определяем переменые nah~
	...
	if ($_POST['order_metod']==25) {
		$message.="<div class='bictext'>Ваш заказ успешно принят! Для оформления кредита, пожалуйста, заполните данную форму".$_POST['bic_code']."</div>"; //style='visibility:hidden;'
		...
		$disp.="<script language='JavaScript'>
