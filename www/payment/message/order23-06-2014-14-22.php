...
// Определяем переменые nah~
	...
	if ($_POST['order_metod']==25) {
		$message.="<div class='bictext'>Ваш заказ успешно принят! Для оформления кредита, пожалуйста, заполните данную <a  id='credit_forma' href='#' onClick='".$_POST['bic_code']."' >форму</a></div>"; //$_POST['bic_code']
