	...
	function catalog_improvements() {
        ...
        if (!empty($_GET['s']) and is_numeric($_GET['s']) and !empty($_GET['f']) and is_numeric($_GET['f'])) {
			...
			if ($this->PHPShopNav->getPage()=='') {
				$sql="select distinct id,category,name,content,price,price_n,sklad,p_enabled,enabled,uid,num,pic_small,parent_enabled,parent,price2,price3,price4,price5,dop_cat from u301639_test.phpshop_productsselect distinct id,category,name,content,price,price_n,sklad,p_enabled,enabled,uid,num,pic_small,parent_enabled,parent,price2,price3,price4,price5,dop_cat from u301639_test.phpshop_products where category in"
				." (SELECT id FROM u301639_test.phpshop_categories where parent_to in"
				." (SELECT id FROM u301639_test.phpshop_categories where parent_to=".$cid_id
				." union all"
				." SELECT id FROM u301639_test.phpshop_categories where id=".$cid_id.")) and enabled='1' and parent_enabled='0' order by ".$orderby." LIMIT 1,".$this->num_row;
				...
				$sql="select distinct id,category,name,content,price,price_n,sklad,p_enabled,enabled,uid,num,pic_small,parent_enabled,parent,price2,price3,price4,price5 from u301639_test.phpshop_products where category in"
				." (SELECT id FROM u301639_test.phpshop_categories where parent_to in"
				." (SELECT id FROM u301639_test.phpshop_categories where parent_to=".$cid_id
				." union all"
				." SELECT id FROM u301639_test.phpshop_categories where id=".$cid_id.")) and enabled='1' and parent_enabled='0' order by ".$orderby;
				$select_array=array('id','category','name','content','price','price_n','sklad','p_enabled','enabled','uid','num','price2','price3','price4','price5');
				...
				$sql="select distinct id,category,name,content,price,price_n,sklad,p_enabled,enabled,uid,num,pic_small,parent_enabled,parent,price2,price3,price4,price5 from u301639_test.phpshop_products where category in"
					...
					." (SELECT id FROM u301639_test.phpshop_categories where parent_to=".$cid_id
					." union all"
					." SELECT id FROM u301639_test.phpshop_categories where id=".$cid_id.")) and enabled='1' and parent_enabled='0' order by ".$orderby.$sql_2;
				$select_array=array('id','category','name','content','price','price_n','sklad','p_enabled','enabled','uid','num','price2','price3','price4','price5');
