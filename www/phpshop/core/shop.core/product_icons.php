...
function product_icons($obj, $row) {
	...
	$shop_urls['м. ƒинамо']="//prodacha.ru/page/store.html";
	$shop_urls['ћинское шоссе']="//prodacha.ru/page/shop.html";
	$shop_urls['Ћахтинский пр-т.']="//prodacha.ru/page/shop_spb.html";
