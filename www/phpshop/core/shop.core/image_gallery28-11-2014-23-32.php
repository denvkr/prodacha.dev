...
<a class=highslide onclick="return hs.expand(this)" href="' . $obj->checkMultibase($name_b, true) . '" target=_blank getParams="null"><img id="currentBigPic" src="' . $obj->checkMultibase($pic_big, true) . '" border="1" class="imgOn" alt="' . $alt . '"
  ...
  <a href="javascript:fotoload(' . $n . ',0);"><img src="' . $FotoArray[0]["name_s"] . '" alt="' . $FotoArray[0]["info"] . '" border="1" class="imgOn" onerror="NoFoto2(this)" style="display: block;max-width:110px;max-height:115px;width: auto;height: auto;"></a></td>';

            if (is_array($FotoArray[1]))
                $disp.='<td align="center">
    <a href="javascript:fotoload(' . $n . ',1);"><img src="' . $FotoArray[1]["name_s"] . '" alt="' . $FotoArray[1]["info"] . '" border="1" class="imgOff" onmouseover="ButOn(this)" onmouseout="ButOff(this)" onerror="NoFoto2(this)" style="display: block;max-width:110px;max-height:115px;width: auto;height: auto;"></a></td>';

            if (is_array($FotoArray[2]))
                $disp.='<td align="center">
     <a href="javascript:fotoload(' . $n . ',2);"><img src="' . $FotoArray[2]["name_s"] . '" alt="' . $FotoArray[2]["info"] . '" border="1" class="imgOff" onmouseover="ButOn(this)" onmouseout="ButOff(this)" onerror="NoFoto2(this)" style="display: block;max-width:110px;max-height:115px;width: auto;height: auto;"></td><td>
