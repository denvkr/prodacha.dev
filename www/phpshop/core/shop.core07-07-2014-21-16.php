...
class PHPShopShop extends PHPShopShopCore {
    ...
    function UID() {
		...
		{	
			...
			$FastOrder='<span class="price_comlain" onclick="fast_order_window(window.location,document.getElementsByClassName(\'netref\'));">'.$this->lang('fast_order').'</span>';
...
*/                
        ...
        $catalog_id_result = $this->PHPShopOrm->query("select id from phpshop_categories where name like '%stihl%'");
    ...
    function CID() {
        ...
        //echo 'blablabla';
        //if (!empty($parent_category_row['id'])) {
        	//if (isset($this->productNotice)) {
        		//$this->productNotice='Купить';
        		//$this->set('productNotice', 'Купить');
        	//}
        //}
    }
