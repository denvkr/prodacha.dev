    ...
    if($deliveryID>0) {
	    ...
	    if ($row['PID']=='1') {
	    	...
	    	if ($_COOKIE['sincity']=="sp") {
	    		...
	    		if ($totalsumma>=5000 && $totalsumma<=9999) {
	    			$sqlvariants="select * from ".$table." where (enabled='1' and PID='".$row['PID']."' and id in ('11','41','44','45','47')) order by city";
	    		}
	    		if ($totalsumma>=10000 && $totalsumma<=19999) {
	    			$sqlvariants="select * from ".$table." where (enabled='1' and PID='".$row['PID']."' and id in ('11','41','44','46','48')) order by city";
	    		}
	    		if ($totalsumma>=20000 && $totalsumma<=49999) {
	    			$sqlvariants="select * from ".$table." where (enabled='1' and PID='".$row['PID']."' and id in ('11','41','44','49','50','51','61','62')) order by city";
	    		}
	    		if ($totalsumma>=50000) {
	    			$sqlvariants="select * from ".$table." where (enabled='1' and PID='".$row['PID']."' and id in ('11','41','44','52','53','54','55','56','57','58','59','60','63')) order by city";
	    		}
	    	}
