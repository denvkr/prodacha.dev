...
/**
 * ƒобавление переменной вывода даты поставки в спецпредложение
 */
function checkStoreElements_mod_supplierdate_hook($obj, $row) {
...
$addHandler = array
    (
    'checkStore' => 'checkStoreElements_mod_supplierdate_hook'
);
?>