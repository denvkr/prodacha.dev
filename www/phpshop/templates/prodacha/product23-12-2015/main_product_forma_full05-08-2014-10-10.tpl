					...
					<tr>
						<td>
							<div class="addchart_block_table_price">
									...
									<span class="price_comlain" >нашли дешевле?</span>
							</div>
						</td>
...
*/
	...
	$sql="select id from phpshop_products where category in (select id from phpshop_categories where name like '%stihl%') and id=".$us_;
