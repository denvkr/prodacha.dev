		...
		<div class="parameters">
			...
			<div class="addchart_block">
				...
				<table class="addchart_block_table">
					...
					<tr>
						<td>
							...
							<div class="addchart_block_table_price">
								...
								<span class="prev_price @collaboration@">@productPriceRub@</span>
							</div>
						...
						<td>
							...
							@ComStartCart@
							<span class="addtochart"><input type="button" onclick="javascript:AddToCartNum(@productUid@,'n@productUid@')" value="В корзину" /></span>
							@ComEndCart@

							@firstcreditpunch@

							@ComStartNotice@
							<span class="addtochart notice">
								<input type="button" onclick="window.location.replace('/users/notice.html?productId=@productUid@');"  value="@productNotice@" />
							</span>
					...
					<tr>
						<td colspan="2"><span class="price_comlain">нашли дешевле?</span></td>
					</tr>
...
<script type="text/javascript">
	$('.price_comlain').click( function() {
		$('#light_box1, #complainlayer-container').show();
		return false;
	});
	
	$('#complainlayer-container .modal-close').click( function() {
