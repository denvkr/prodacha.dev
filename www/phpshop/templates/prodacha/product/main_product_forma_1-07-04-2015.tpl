...
@Producticons@ 
   <span class="prev_price"><noindex>@productPriceRub@</noindex></span> @ComStart@ <span class="price">@productPrice@<span class="smallfont">&nbsp@productValutaName@</span></span>
