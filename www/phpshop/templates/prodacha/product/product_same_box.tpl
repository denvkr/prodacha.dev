<div id="same_tovar@same_tovar_num@" class="same_tovar@same_tovar_num@">
<div class="tovar">
    ...
    if ($stihl_catalog_search==true || $viking_catalog_search==true) {
        ...
        if ($row_sklad==true && $row_outdated==false) {
            ...
            if ($row_sklad==true && $row_outdated==false) {
                    ...
                    echo '<div class="prev_price" style="top: 245px;left: '.$left.'px;text-decoration:line-through;">'.$old_price;
            }
        }
