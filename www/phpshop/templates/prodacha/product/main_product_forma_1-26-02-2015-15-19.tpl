   ...
   @ComEnd@
    ...
    if ($stihl_catalog_search==true || $viking_catalog_search==true) {
		...
		if ($row_sklad==true && $row_outdated==false) {
			...
			//$productnotice='<div class="prev_price" style="position:relative;display: inline-block;top:3px;margin:-15px 0px 0px 10px;font-size:12px !important;"><noindex>'.$SysValue['lang']['outdated_message'].'</noindex></div>';
