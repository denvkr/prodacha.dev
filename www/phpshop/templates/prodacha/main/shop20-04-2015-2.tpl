	...
	<div class="head">
		...
		<div class="phone">
			...
			@php
					...
					echo $telnum[$city];							
			php@
			<div id="reverse_call_href" class="catalog page_nava" style="color: #588910;cursor:pointer;width:40px;text-decoration:underline;" onclick="ask_reverse_call(document.getElementsByClassName('netref'))">Заказать звонок</div>
			</span>
		</div>
		<div class="work_time">
          	@php
