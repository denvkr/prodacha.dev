...
function display_tovar_delivery_hook($obj, $row) {
	...
	$tab7_html.=PHPShopText::nbsp(1).$city.'</b></h3>';	
		...
		while ($row_tab7=mysql_fetch_assoc($res_tab7)) {
			...
			switch ($row_tab7['city']) {
				...
				case 'Санкт-Петербург за пределами КАД от 41 до 50 км.':
					...
					$city='- Санкт-Петербург за пределами КАД от 41 до 50 км.';
					break;
				case 'Доставка и отгрузка в транспортную компанию ';
					$city='- Доставка и отгрузка в транспортную компанию';
					break;
...
function display_tovar_samovyvoz_hook($obj, $row) {
	...
	$edostout='<p><b style="font-size:18px;">Доставка по России через транспортные компании и Почту России</b></p>';
	$edostout.='<form name="calc" method="post" onSubmit="return false;">';
	$edostout.='<table id="calc1" width="800" cellpadding="5" cellspacing="0" border="0">';
	...
	$edostout.='<td width="300" align="left">Индекс:(Для отправки Почтой России)</td>';	
	$edostout.='</tr>';
	
	$edostout.='<tr height="25">';
	$edostout.='<td align="right">Куда:</td>';
	$edostout.='<td align="right"><input type="text" id="edost_to_city" name="edost_to_city" size="35" maxlength="80" title="Начните вводить название города" value=""></td>';
	$edostout.='<td align="center"><span id="ToReg">-</span></td>';
	$edostout.='<td><input type="text" id="edost_zip" name="edost_zip" size="6" maxlength="6"></td>';
	$edostout.='</tr>';
	
	$edostout.='<tr height="0">';
	$edostout.='<td style="visibility:hidden;" align="right">Индекс:</td>';
	$edostout.='<td style="visibility:hidden;"><input type="text" id="edost_zip" name="edost_zip" size="6" maxlength="6"></td>';
	...
	$edostout.='<td><input type="submit" name="B_Calc" value="Рассчитать" onclick="cr1();"></td>';
	$edostout.='</tr>';
	
	$edostout.='<tr height="0">';
	$edostout.='<td align="right">Вес:</td>'; //style="visibility:hidden;"
	$edostout.='<td><input type="text" id="edost_weight" name="edost_weight" size="5" maxlength="5" value="'.$row['weight'].'"> кг.</td>'; //style="visibility:hidden;"
	$edostout.='<td><p id="Err1" style="color:red"></p></td>'; //style="visibility:hidden;"
	$edostout.='<td></td>';	//style="visibility:hidden;"
	$edostout.='</tr>';
	
	$edostout.='<tr height="0">';
	$edostout.='<td align="right">Оценка:</td>'; //style="visibility:hidden;"
	$edostout.='<td><input type="text" id="edost_strah" name="edost_strah" size="10" maxlength="12" value="'.$price.'"> руб.</td>'; //style="visibility:hidden;"
	$edostout.='<td></td>'; //style="visibility:hidden;"
	$edostout.='<td></td>';	//style="visibility:hidden;"
	$edostout.='</tr>';
	
	$edostout.='<tr height="0">';
	$edostout.='<td align="right">Длина:</td>'; //style="visibility:hidden;"
	$edostout.='<td><input type="text" id="edost_lenght" name="edost_lenght" size="10" maxlength="10" value="'.$row['length'].'"> см.</td>'; //style="visibility:hidden;"
	$edostout.='<td></td>'; //style="visibility:hidden;"
	$edostout.='<td></td>'; //style="visibility:hidden;"
	$edostout.='</tr>';
	
	$edostout.='<tr height="0">';
	$edostout.='<td align="right">Ширина:</td>'; //style="visibility:hidden;"
	$edostout.='<td><input type="text" id="edost_width" name="edost_width" size="10" maxlength="10" value="'.$row['width'].'"> см.</td>'; //style="visibility:hidden;"
	$edostout.='<td></td>'; //style="visibility:hidden;"
	$edostout.='<td></td>'; //style="visibility:hidden;"	
	$edostout.='</tr>';
	
	$edostout.='<tr height="0">';
	$edostout.='<td align="right">Высота:</td>'; //style="visibility:hidden;"
	$edostout.='<td><input type="text" id="edost_height" name="edost_height" size="10" maxlength="10" value="'.$row['height'].'"> см.</td>'; //style="visibility:hidden;"
	$edostout.='<td></td>'; //style="visibility:hidden;"
	$edostout.='<td></td>';	//style="visibility:hidden;"
	$edostout.='</tr>';
