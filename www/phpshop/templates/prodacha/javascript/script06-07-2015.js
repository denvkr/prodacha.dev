...
$(document).ready(function() {	
	...
	*/
	...
	$('.left .menu .mainmenu > li').click(function ( event ) {
		...
		if ($(this).children("span").text().toLowerCase()=='мотоблоки и культиваторы') {
			...
			if ($($($(this).nextAll('li').children('span')).get(2)).text().toLowerCase()=="навесное оборудование для мотоблоков") {
			...
			if ($($($(this).nextAll('li').children('span')).get(4)).text().toLowerCase()=="запчасти, расходники для мотоблоков") {			
			...
			spanelements.each(function( index ) {
				...
				if ($(this).find('span:first').text().toLowerCase()=='навесное оборудование для мотоблоков') {
				...
				if ($(this).find('span:first').text().toLowerCase()=='запчасти, расходники для мотоблоков') {
		...
		if ($(this).children("span").text().toLowerCase()=='техника для газона') {
			...
			if ($($($(this).nextAll('li').children('span')).get(6)).text().toLowerCase()=="триммеры для травы") {			
			...
			if ($($($(this).nextAll('li').children('span')).get(7)).text().toLowerCase()=="аэраторы, вертикуттеры, скарификаторы") {			
			...
			if ($($($(this).nextAll('li').children('span')).get(8)).text().toLowerCase()=="сенокосилки фронтальные") {			
			...
			if ($($($(this).nextAll('li').children('span')).get(9)).text().toLowerCase()=="садовые ножницы и кусторезы") {			
			...
			spanelements.each(function( index ) {
				...
				if ($(this).find('span:first').text().toLowerCase()=='триммеры для травы') {
				...
				if ($(this).find('span:first').text().toLowerCase()=='аэраторы, вертикуттеры, скарификаторы') {
				...
				if ($(this).find('span:first').text().toLowerCase()=='садовые ножницы и кусторезы') {
		...
		if ($(this).children("span").text().toLowerCase()=='благоустройство участка') {
			...
			if ($($($(this).nextAll('li').children('span')).get(13)).text().toLowerCase()=="мотопомпы для воды") {
				//console.log("мотопомпы для воды");				
			...
			if ($($($(this).nextAll('li').children('span')).get(14)).text().toLowerCase()=="водяные насосы") {
				//console.log("водяные насосы");				
			...
			if ($($($(this).nextAll('li').children('span')).get(15)).text().toLowerCase()=="садовые воздуходувы") {
				//console.log("садовые воздуходувы");				
			...
			if ($($($(this).nextAll('li').children('span')).get(16)).text().toLowerCase()=="дровоколы") {
			...
			if ($($($(this).nextAll('li').children('span')).get(17)).text().toLowerCase()=="садовые измельчители") {
			...
			if ($($($(this).nextAll('li').children('span')).get(18)).text().toLowerCase()=="высоторезы") {			
			...
			if ($($($(this).nextAll('li').children('span')).get(19)).text().toLowerCase()=="виброплиты") {
			...
			spanelements.each(function( index ) {
				...
				if ($(this).find('span:first').text().toLowerCase()=='мотопомпы для воды') {
				...
				if ($(this).find('span:first').text().toLowerCase()=='водяные насосы') {
	...
	*/
	...
	if ($('#mail').length || $("#name_person").length || $("#tel_name").length || $("#edost_to_city").length) {
		...
		$("#tel_name").inputmask("mask",{mask: "9999999999"});//{mask: "+7(9##)###-##-##"}
	...
	$.ajax({
		...
		success: function(json) {
			if (json['ok'] == '1'){
				...
				html +=	'<input type="text" '+yo_name_top+' id="yo_name" name="yo_name" onblur="checkresult_value(this);" value="" placeholder="Имя" pattern="^[\-A-Za-z\u0410-\u044F]+$" maxlength="100"/>&nbsp<span '+yo_name_top_comment+'>обязательное поле</span>';
				html +=	'<input type="tel" '+yo_phone_top+' id="yo_phone" name="yo_phone" onblur="checkresult_value(this);" value="" placeholder="+79101234567" pattern="^[\+0-9]{7,12}$" maxlength="12"/>&nbsp<span '+yo_phone_top_comment+'>обязательное поле</span>';
				html +=	'<input type="text" '+yo_mail_top+' id="yo_mail" name="yo_mail" onblur="checkresult_value(this);" value="" placeholder="ivan@prodacha.ru" pattern="^[a-z0-9!#$%&\'*+\/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&\'*+\/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?$" maxlength="100"/>';
				html +=	'</div>';	
				html +=	'<input id="cv3" type="hidden" name="cv3" value="nohspamcode" />';
