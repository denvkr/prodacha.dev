	...
	$('.left .menu .mainmenu > li').click(function ( event ) {
		...
		*/
		...
		if ($(this).children("span").text().toLowerCase()=='благоустройство участка') {
			...
			//проверяем если подкаталоги развернуты то скрываем если скрыты то разворачиваем
			if ($($($(this).nextAll('li').children('span')).get(13)).text().toLowerCase()=="мотобуры") {
			...
			if ($($($(this).nextAll('li').children('span')).get(14)).text().toLowerCase()=="мотопомпы") {
			...
			if ($($($(this).nextAll('li').children('span')).get(15)).text().toLowerCase()=="воздуходувы") {
