	...
	*/
	...
	$('.left .menu .mainmenu > li').click(function ( event ) {
		...
		*/
		...
		if ($(this).children("span").text().toLowerCase()=='техника по производителю') {

			//проверяем если подкаталоги развернуты то скрываем если скрыты то разворачиваем
			if ($($($(this).nextAll('li').children('span')).get(19)).text().toLowerCase()=="садовая техника мобил к") {
				//console.log("мотобуры");					
			...
			var spanelements=$('.mainmenu').find("li");
			spanelements.each(function( index ) {
				if ($(this).find('span:first').text().toLowerCase()=='садовая техника мобил к') {
