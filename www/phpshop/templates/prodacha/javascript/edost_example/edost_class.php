...
$edost_id=$SysValue['lang']['edost_id'];
$edost_pwd=$SysValue['lang']['edost_pwd'];
$edost_id=5186;
$edost_pwd="8euPTpje91lotV6iZ4VAdZtuGsY8nYc5";
//---------- ВНИМАНИЕ!!! ----------
//скопировать из настроек магазина в личном кабинете edost.ru
define("EDOST_ID", $edost_id); //Идентификатор магазина (вписать вместо: 0)
define("EDOST_PSWD", $edost_pwd); //Пароль для доступа к серверу расчетов (вписать вместо: password)
//---------- ВНИМАНИЕ!!! ----------
