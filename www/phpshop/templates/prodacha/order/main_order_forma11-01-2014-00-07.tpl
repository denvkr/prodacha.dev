...
<form method="post" name="forma_order" action="/done/">
  <table  cellpadding="5" cellspacing="0" width=100% >
    ...
    <tr>
      <td align="left" colspan="2" style="font-size: 10px; padding-left: 170px;">* Доставка производится для заказов от 3000 руб. Заказ стоимостью<br /> менее 3000 руб. Вы можете забрать самовывозом из наших магазинов.</td>
    </tr>
    <tr valign="top">
