...
<form method="post" name="forma_order" action="/done/">
  <table  cellpadding="5" cellspacing="0" width=100% >
    ...
    <tr>
      <td id="delivery_warning" align="left" colspan="2" style="font-size: 10px; padding-left: 170px; display:none">* Доставка по Москве производится для заказов от 3000 руб.<br /> Доставка в транспортные компании (ТК) для заказов от 1000 руб.<br />Подробные условия доставки доступны <a href="http://prodacha.ru/page/delivery.html" style="text-decoration: underline;">по ссылке.</a></td>
    </tr>
    <tr valign="top">
