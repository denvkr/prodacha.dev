  ...
  <table  cellpadding="5" cellspacing="0" width=100% >
    ...
    <tr>
      ...
      <td>
 	      ...
 	      <input type="text" id="tel_name" name="tel_name" style="width:150px; height:18px; font-family:tahoma; font-size:11px; color:#4F4F4F;" maxlength="11" title="Введите телефон в формате: [xxx xxxxxxx] код города тел. номер" value="@UserTel@">
          <img src="images/shop/flag_green.gif" alt="" width="16" height="16" border="0" hspace="5" align="middle"/>
      </td>
    </tr>
    <tr>
