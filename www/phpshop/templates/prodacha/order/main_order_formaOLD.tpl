 @ComStartReg@
<!--<div  id=allspecwhite style="margin-bottom:20px"> <img src="images/shop/icon_key.gif" alt="" width="16" height="16" border="0" hspace="5" align="middle"/> <a href="/users/register.html" class="b">Зарегистрируйтесь</a> и получите дополнительные возможности и <b>скидки</b>. </div> -->
@ComEndReg@
<p><br>
</p>
  ...
  <table  cellpadding="5" cellspacing="0" width=100% >
    ...
    <tr>
      <td colspan="2" align="center"><p><br>
        ...
        <table align="center">
          <tr>
            <td><img src="images/shop/brick_go.gif"  border="0" style="vertical-align: middle;" />&nbsp;&nbsp;<a href="javascript:OrderChek();" class=link style="font-size: 18px; font-weight: bold;">Оформить заказ</a></td>
            <td width="150"></td>
            <td><img src="images/shop/brick_error.gif" border="0" style="vertical-align: middle;" />&nbsp;&nbsp;<a href="javascript:forma_order.reset();" class=link style="font-size: 18px; font-weight: bold;">Очистить форму</a></td>
          </tr>
        </table>
