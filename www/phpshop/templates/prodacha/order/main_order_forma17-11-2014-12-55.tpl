...
<form method="post" name="forma_order" action="/done/">
  <table  cellpadding="5" cellspacing="0" width=100% >
    ...
    <tr>
      <td id="delivery_warning" align="left" colspan="2" style="font-size: 10px; padding-left: 170px; display:none">* Доставка по Москве производится для заказов от 3000 руб. Заказ стоимостью<br /> менее 3000 руб. Вы можете забрать самовывозом из наших магазинов.</td>
    </tr>
    <tr valign="top">
    ...
    <tr>
	  ...
	  <div id="order_metod_div" style="display:none;"><input type="radio" name="order_metod" value="26" onClick="document.getElementById('bin').style.display='block';document.getElementById('bic').style.display='none';" >Оплата в магазине картой VISA, Mastercard<br></div>
    ...
    <tr>
      <td align="right" style="color: gray;" ><div id="org_name_info" style="display:none;">Компания: </div></td>
      <td><div id="org_name_value" style="display:none;"><input type="text" name="org_name" style="width:300px; height:18px; font-family:tahoma; font-size:11px ; color:#4F4F4F " maxlength="100" value="@UserComp@" @formaLock@></div>
      </td>
    </tr>
    <tr>
      <td align="right" style="color: gray;" ><div id="org_inn_info" style="display:none;">ИНН: </div></td>
      <td><div id="org_inn_value" style="display:none;"><input type="text" name="org_inn" style="width:150px; height:18px; font-family:tahoma; font-size:11px ; color:#4F4F4F " maxlength="50" value="@UserInn@" @formaLock@></div>
      </td>
    </tr>
    <tr>
      <td align="right" style="color: gray;" ><div id="org_kpp_info" style="display:none;">КПП: </div></td>
      <td><div id="org_kpp_value" style="display:none;"><input type="text" name="org_kpp" style="width:150px; height:18px; font-family:tahoma; font-size:11px ; color:#4F4F4F " maxlength="50" value="@UserKpp@" @formaLock@></div>
      </td>
    </tr>
