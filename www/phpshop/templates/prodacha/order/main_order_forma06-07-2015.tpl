  ...
  <table  cellpadding="5" cellspacing="0" width=100% >
    ...
    <tr>
      ...
      <td>
 	      ...
 	      <input type="text" id="tel_name" name="tel_name" style="width:150px; height:18px; font-family:tahoma; font-size:11px; color:#4F4F4F;" data-container="body" class="tooltip" role="tooltip" data-toggle="tooltip" data-content="Введите 10 цифр моб. телефона без восьмерки в формате: [9011234567]" placeholder="9101234567" maxlength="10" value="@UserTel@">
 	      <!--pattern="^\+[0-9\(\)]{17}$"-->
          <img src="images/shop/flag_green.gif" alt="" width="16" height="16" border="0" hspace="5" align="middle"/>
      </td>
    </tr>
