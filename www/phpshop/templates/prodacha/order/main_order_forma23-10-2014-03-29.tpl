...
<form method="post" name="forma_order" action="/done/">
  <table  cellpadding="5" cellspacing="0" width=100% >
    ...
    <tr>
	  ...
	  <div id="order_metod_div"><input type="radio" name="order_metod" value="26" onClick="document.getElementById('bin').style.display='block';document.getElementById('bic').style.display='none';" >Оплата в магазине картой VISA, Mastercard<br></div>
