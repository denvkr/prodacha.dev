...
*/
	...
	function custommenuoutput ($row,$i) {
		...
		if ($row['id']=='288') {
			...
			$submenuhead='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Мотоблоки</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_288.html" title="мотоблоки и культиваторы">мотоблоки и культиваторы</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_37.html" title="мотоблоки">мотоблоки</a></span></li>';
			$submenuhead.='</ul>';
			//********************************************************************* 37 ***********************************************************************************
			...
			$submenuhead.='<p id="catpage1_37" class="menublock" >По типу:</p><ul id="ul_cat_page_1_37" class="catalogPodcatalog1">';
			...
			$submenuhead.='<p id="catpage2_37" class="menublock" >По производителю:</p><ul id="ul_cat_page_2_37" class="catalogPodcatalog2">';
			...
			//$this->set('sub_li','<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Культиваторы</span>',true);
			$submenuhead.='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Культиваторы</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_288.html" title="мотоблоки и культиваторы">мотоблоки и культиваторы</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_44.html" title="культиваторы">культиваторы</a></span></li>';
			$submenuhead.='</ul>';
			//********************************************************************* 44 ***********************************************************************************
			//генерация первого раздела меню "по типу"
			...
			$submenuhead.='<p id="catpage1_44" class="menublock" >По типу:</p><ul id="ul_cat_page_1_44" class="catalogPodcatalog1">';
			...
			$submenuhead.='<p id="catpage2_44" class="menublock" >По производителю:</p><ul id="ul_cat_page2_44"  class="catalogPodcatalog2">';
			...
			//$this->set('sub_li','<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Навесное оборудование</span>',true);
			$submenuhead.='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Навесное оборудование</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_288.html" title="мотоблоки и культиваторы">мотоблоки и культиваторы</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_16.html" title="Навесное оборудование для мотоблоков">Навесное оборудование для мотоблоков</a></span></li>';
			$submenuhead.='</ul>';							
			//********************************************************************* 16 ***********************************************************************************
			//генерация первого раздела меню "по типу"
			//$res=$this->PHPShopOrm->query($sql_1);
			...
			$submenuhead.='<p id="catpage1_16" class="menublock" >По типу:</p><ul id="ul_cat_page_1_16" class="catalogPodcatalog1">';
			...
			$submenuhead.='<p id="catpage2_16" class="menublock" >По производителю:</p><ul id="ul_cat_page2_16"  class="catalogPodcatalog2">';
			...
			//$this->set('sub_li','<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Двигатели для мотоблоков</span>',true);
			$submenuhead.='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Двигатели для мотоблоков</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_288.html" title="мотоблоки и культиваторы">мотоблоки и культиваторы</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_5.html" title="Двигатели для мотоблоков">Двигатели для мотоблоков</a></span></li>';
			$submenuhead.='</ul>';
			//********************************************************************* 48 ***********************************************************************************					
			//генерация первого раздела меню "по типу"
			//$res=$this->PHPShopOrm->query($sql_1);
			...
			$submenuhead.='<p id="catpage1_5" class="menublock" >По типу:</p><ul id="ul_cat_page_1_5" class="catalogPodcatalog1">';
			...
			$submenuhead.='<p id="catpage2_5" class="menublock" >По производителю:</p><ul id="ul_cat_page2_5"  class="catalogPodcatalog2">';
			...
			//$this->set('sub_li','<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;padding: 6px 0px 6px 15px;"><span style="font-size: 12px;line-height: 1;">Запчасти, расходники</span>',true);						
			$submenuhead.='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span style="font-size: 12px;line-height: 1;">Запчасти, расходники</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_288.html" title="мотоблоки и культиваторы">мотоблоки и культиваторы</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_36.html" title="Запчасти, расходники">Запчасти, расходники</a></span></li>';
			$submenuhead.='</ul>';							
			//********************************************************************* 36 ***********************************************************************************					
			//генерация первого раздела меню "по типу"
			//$res=$this->PHPShopOrm->query($sql_1);
			...
			$submenuhead.='<p id="catpage1_36" class="menublock" >По типу:</p><ul id="ul_cat_page_1_36" class="catalogPodcatalog1">';
			...
			$submenuhead.='<p id="catpage2_36" class="menublock" >По производителю:</p><ul id="ul_cat_page2_36"  class="catalogPodcatalog2">';
			...
			$sql_1="select id,name,case parent_to when 18 then 1 when 85 then 2 when 215 then 3 when 297 then 4 when 298 then 5 when 299 then 6 when 254 then 7 when 272 then 8 end as category_id from `phpshop_categories` where parent_to in (18,85,215,297,298,299,254,272) and name not like '%(%)%' order by num";
			$sql_2="select id,name,case parent_to when 18 then 1 when 85 then 2 when 215 then 3 when 297 then 4 when 298 then 5 when 299 then 6 when 254 then 7 when 272 then 8 end as category_id from `phpshop_categories` where parent_to in (18,85,215,297,298,299,254,272) and name like '%(%)%' order by num";
			...
			$submenuhead='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Газонокосилки</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_290.html" title="техника для ухода за газоном">техника для ухода за газоном</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_18.html" title="газонокосилки">газонокосилки</a></span></li>';
			$submenuhead.='</ul>';							
			//********************************************************************* 18 ***********************************************************************************					
			//генерация первого раздела меню "по типу"
			$this->PHPShopOrm->cache = true;
			...
			$submenuhead.='<p id="catpage1_18" class="menublock" >По типу:</p><ul id="ul_cat_page_1_18" class="catalogPodcatalog1">';
			...
			foreach ($res1 as $prod_row1) {	
				...
				if ($prod_row1[category_id]==2 && $prod_row1[id]==35) {
					$submenuhead2_1.='<li><span class="inside_menu_head" style="font-size:12px;"><a href="/shop/CID_'.$prod_row1[id].'.html" title="'.$prod_row1[name].'">'.$prod_row1[name].'</a>&nbsp';
					$submenuhead2_1.='(<a href="/shop/CID_333.html" style="font-size:12px;" title="Мотокосы">Мотокосы</a>,&nbsp';
					$submenuhead2_1.='<a href="/shop/CID_334.html" style="font-size:12px;" title="Бензокосы">Бензокосы</a>)</span></li>';
			...
			$submenuhead.='<p id="catpage2_18" class="menublock" >По производителю:</p><ul id="ul_cat_page2_18"  class="catalogPodcatalog2">';
			$submenuhead1_2='';
			$submenuhead2_2='';
			$submenuhead3_2='';
			$submenuhead4_2='';
			...
			foreach ($res2 as $prod_row2) {
				...
				if ($prod_row2[category_id]==8) {
					$submenuhead8_2.='<li><span class="inside_menu_head"><a href="/shop/CID_'.$prod_row2[id].'.html" title="'.$prod_row2[name].'">'.$prod_row2[name].'</a></span></li>';					
				}				
			}
			$submenuhead.=$submenuhead1_2;
			$submenuhead.='</ul>';
			...
			//$this->set('sub_li','<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Триммеры, кусторезы</span>',true);
			$submenuhead.='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Триммеры</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_290.html" title="техника для ухода за газоном">техника для ухода за газоном</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_85.html" title="триммеры">триммеры</a></span></li>';
			$submenuhead.='</ul>';							
			//********************************************************************* 85 ***********************************************************************************					
			//генерация первого раздела меню "по типу"
			//$res=$this->PHPShopOrm->query($sql_1);
			...
			$submenuhead.='<p id="catpage1_85" class="menublock" >По типу:</p><ul id="ul_cat_page_1_85" class="catalogPodcatalog1">';
			...
			$submenuhead.='<p id="catpage2_85" class="menublock" >По производителю:</p><ul id="ul_cat_page2_85"  class="catalogPodcatalog2">';
			...
			//$this->set('sub_li','<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Аэраторы, вертикуттеры</span>',true);
			$submenuhead.='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Аэраторы, вертикуттеры</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_290.html" title="техника для ухода за газоном">техника для ухода за газоном</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_215.html" title="аэраторы, вертикуттеры">аэраторы, вертикуттеры</a></span></li>';
			$submenuhead.='</ul>';							
			//********************************************************************* 215 ***********************************************************************************					
			//генерация первого раздела меню "по типу"
			//$res=$this->PHPShopOrm->query($sql_1);
			...
			$submenuhead.='<p id="catpage1_215" class="menublock" >По типу:</p><ul id="ul_cat_page_1_215" class="catalogPodcatalog1">';
			...
			$submenuhead.='<p id="catpage2_215" class="menublock" >По производителю:</p><ul id="ul_cat_page2_215"  class="catalogPodcatalog2">';
			...
			//$this->set('sub_li','<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Аэраторы, вертикуттеры</span>',true);
			$submenuhead.='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Садовые ножницы</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_290.html" title="техника для ухода за газоном">техника для ухода за газоном</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_297.html" title="садовые ножницы">садовые ножницы</a></span></li>';
			$submenuhead.='</ul>';							
			//********************************************************************* 215 ***********************************************************************************					
			//генерация первого раздела меню "по типу"
			//$res=$this->PHPShopOrm->query($sql_1);
			...
			$submenuhead.='<p id="catpage1_297" class="menublock" >По типу:</p><ul id="ul_cat_page_1_297" class="catalogPodcatalog1">';
			...
			$submenuhead.='<p id="catpage2_297" class="menublock" >По производителю:</p><ul id="ul_cat_page2_297"  class="catalogPodcatalog2">';
			...
			//$this->set('sub_li','<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Аэраторы, вертикуттеры</span>',true);
			$submenuhead.='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Высоторезы</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_290.html" title="техника для ухода за газоном">техника для ухода за газоном</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_298.html" title="высоторезы">высоторезы</a></span></li>';
			$submenuhead.='</ul>';							
			//********************************************************************* 215 ***********************************************************************************					
			//генерация первого раздела меню "по типу"
			//$res=$this->PHPShopOrm->query($sql_1);
			...
			$submenuhead.='<p id="catpage1_298" class="menublock" >По типу:</p><ul id="ul_cat_page_1_298" class="catalogPodcatalog1">';
			...
			$submenuhead.='<p id="catpage2_298" class="menublock" >По производителю:</p><ul id="ul_cat_page2_298"  class="catalogPodcatalog2">';
			...
			//$this->set('sub_li','<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Аэраторы, вертикуттеры</span>',true);
			$submenuhead.='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Сенокосилки фронтальные</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_290.html" title="техника для ухода за газоном">техника для ухода за газоном</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_299.html" title="сенокосилки фронтальные">cенокосилки фронтальные</a></span></li>';
			$submenuhead.='</ul>';							
			//********************************************************************* 215 ***********************************************************************************					
			//генерация первого раздела меню "по типу"
			//$res=$this->PHPShopOrm->query($sql_1);
			...
			$submenuhead.='<p id="catpage1_299" class="menublock" >По типу:</p><ul id="ul_cat_page_1_299" class="catalogPodcatalog1">';
			...
			$submenuhead.='<p id="catpage2_299" class="menublock" >По производителю:</p><ul id="ul_cat_page2_299"  class="catalogPodcatalog2">';
			...
			//$this->set('sub_li','<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Аэраторы, вертикуттеры</span>',true);
			$submenuhead.='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Подрезчики края газона</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_290.html" title="техника для ухода за газоном">техника для ухода за газоном</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_254.html" title="подрезчики края газона">подрезчики края газона</a></span></li>';
			$submenuhead.='</ul>';							
			//********************************************************************* 215 ***********************************************************************************					
			//генерация первого раздела меню "по типу"
			//$res=$this->PHPShopOrm->query($sql_1);
			...
			$submenuhead.='<p id="catpage1_254" class="menublock" >По типу:</p><ul id="ul_cat_page_1_254" class="catalogPodcatalog1">';
			...
			$submenuhead.='<p id="catpage2_254" class="menublock" >По производителю:</p><ul id="ul_cat_page2_254"  class="catalogPodcatalog2">';
			...
			//$this->set('sub_li','<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Аэраторы, вертикуттеры</span>',true);
			$submenuhead.='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Садовые катки и валики</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_290.html" title="техника для ухода за газоном">техника для ухода за газоном</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_272.html" title="садовые катки и валики">садовые катки и валики</a></span></li>';
			$submenuhead.='</ul>';							
			//********************************************************************* 215 ***********************************************************************************					
			//генерация первого раздела меню "по типу"
			//$res=$this->PHPShopOrm->query($sql_1);
			...
			$submenuhead.='<p id="catpage1_272" class="menublock" >По типу:</p><ul id="ul_cat_page_1_272" class="catalogPodcatalog1">';
			...
			$submenuhead.='<p id="catpage2_272" class="menublock" >По производителю:</p><ul id="ul_cat_page2_272"  class="catalogPodcatalog2">';
			...
			$sql_1="select id,name,case parent_to when 142 then 1 when 293 then 2 when 88 then 3 when 224 then 4 when 256 then 5 when 172 then 6 end as category_id from `phpshop_categories` where parent_to in (293,88,142,172,224,256) and name not like '%(%)%' order by num";
			$sql_2="select id,name,case parent_to when 142 then 1 when 293 then 2 when 88 then 3 when 224 then 4 when 256 then 5 when 172 then 6 end as category_id from `phpshop_categories` where parent_to in (293,88,142,172,224,256) and name like '%(%)%' order by num";			
			...
			$submenuhead='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Мотобуры</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_292.html" title="техника для благоустройства участка">техника для благоустройства участка</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_142.html" title="мотобуры">мотобуры</a></span></li>';
			$submenuhead.='</ul>';							
			//********************************************************************* 293 ***********************************************************************************					
			//генерация первого раздела меню "по типу"
			$this->PHPShopOrm->cache = true;
			...
			$submenuhead.='<p id="catpage1_142" class="menublock" >По типу:</p><ul id="ul_cat_page_1_142" class="catalogPodcatalog1">';
			...
			$submenuhead.='<p id="catpage2_142" class="menublock" >По производителю:</p><ul id="ul_cat_page2_142"  class="catalogPodcatalog2">';
			...
			//$this->set('sub_li','<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Воздуходувы</span>',true);
			$submenuhead.='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Мотопомпы</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';							
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_292.html" title="техника для благоустройства участка">техника для благоустройства участка</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_293.html" title="мотопомпы">мотопомпы</a></span></li>';
			$submenuhead.='</ul>';							
			//********************************************************************* 88 ***********************************************************************************					
			//генерация первого раздела меню "по типу"
			//$res=$this->PHPShopOrm->query($sql_1);
			...
			$submenuhead.='<p id="catpage1_293" class="menublock" >По типу:</p><ul id="ul_cat_page_1_293" class="catalogPodcatalog1">';
			...
			$submenuhead.='<p id="catpage2_293" class="menublock" >По производителю:</p><ul id="ul_cat_page2_293"  class="catalogPodcatalog2">';
			...
			//$this->set('sub_li','<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Мотобуры, бензобуры</span>',true);
			$submenuhead.='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Воздуходувы</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';		
			$submenuhead.='<ul>';							
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_292.html" title="техника для благоустройства участка">техника для благоустройства участка</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_88.html" title="воздуходувы">воздуходувы</a></span></li>';
			$submenuhead.='</ul>';								
			//********************************************************************* 142 ***********************************************************************************					
			//генерация первого раздела меню "по типу"
			//$res=$this->PHPShopOrm->query($sql_1);
			...
			$submenuhead.='<p id="catpage1_88" class="menublock" >По типу:</p><ul id="ul_cat_page_1_88" class="catalogPodcatalog1">';
			...
			$submenuhead.='<p id="catpage2_88" class="menublock" >По производителю:</p><ul id="ul_cat_page2_88"  class="catalogPodcatalog2">';
			...
			//$this->set('sub_li','<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Виброплиты</span>',true);
			$submenuhead.='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Дровоколы</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';							
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_292.html" title="техника для благоустройства участка">техника для благоустройства участка</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_224.html" title="дровоколы">дровоколы</a></span></li>';
			$submenuhead.='</ul>';							
			//********************************************************************* 172 ***********************************************************************************					
			//генерация первого раздела меню "по типу"
			//$res=$this->PHPShopOrm->query($sql_1);
			...
			$submenuhead.='<p id="catpage1_224" class="menublock" >По типу:</p><ul id="ul_cat_page_1_224" class="catalogPodcatalog1">';
			...
			$submenuhead.='<p id="catpage2_224" class="menublock" >По производителю:</p><ul id="ul_cat_page2_224"  class="catalogPodcatalog2">';
			...
			//$this->set('sub_li','<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Дровоколы, измельчители</span>',true);
			$submenuhead.='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Садовые измельчители</span>';					
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';							
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_292.html" title="техника для благоустройства участка">техника для благоустройства участка</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_256.html" title="садовые измельчители">садовые измельчители</a></span></li>';
			$submenuhead.='</ul>';							
			//********************************************************************* 224 ***********************************************************************************					
			//генерация первого раздела меню "по типу"
			//$res=$this->PHPShopOrm->query($sql_1);
			...
			$submenuhead.='<p id="catpage1_256" class="menublock" >По типу:</p><ul id="ul_cat_page_1_256" class="catalogPodcatalog1">';
			...
			$submenuhead.='<p id="catpage2_256" class="menublock" >По производителю:</p><ul id="ul_cat_page2_256"  class="catalogPodcatalog2">';
			...
			//$this->set('sub_li','<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Дровоколы, измельчители</span>',true);
			$submenuhead.='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Виброплиты</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_292.html" title="техника для благоустройства участка">техника для благоустройства участка</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_172.html" title="виброплиты">виброплиты</a></span></li>';
			$submenuhead.='</ul>';
			//********************************************************************* 224 ***********************************************************************************
			//генерация первого раздела меню "по типу"
			//$res=$this->PHPShopOrm->query($sql_1);
			...
			$submenuhead.='<p id="catpage1_172" class="menublock" >По типу:</p><ul id="ul_cat_page_1_172" class="catalogPodcatalog1">';
			...
			$submenuhead.='<p id="catpage2_172" class="menublock" >По производителю:</p><ul id="ul_cat_page2_172"  class="catalogPodcatalog2">';
			...
			//$this->set('sub_li','<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Мотопомпы</span>',true);
			$submenuhead='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>садовая техника мобил к</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_327.html" title="">техника по производителю</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_328.html" title="мотобуры">садовая техника мобил к</a></span></li>';
			$submenuhead.='</ul>';
			//********************************************************************* 293 ***********************************************************************************
			//генерация первого раздела меню "по типу"
			$this->PHPShopOrm->cache = true;
			...
			$submenuhead.='<p id="catpage1_328" class="menublock" >По типу:</p><ul id="ul_cat_page_1_328" class="catalogPodcatalog1">';
			...
			$submenuhead.='<p id="catpage2_327" class="menublock" >По производителю:</p><ul id="ul_cat_page2_327"  class="catalogPodcatalog2">';
		...
		else
		{
			...
			//nah~ делим меню каталога на 2 типа
