...
*/
	...
	function custommenuoutput ($row,$i) {
		...
		if ($row['id']=='288') {
			...
			$submenuhead.='<ul>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_'.$row[id].'.html" title="'.$row[name].'">'.$row[name].'</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_'.$parent_id4.'.html" title="'.$parent_cat_name4.'">'.$parent_cat_name4.'</a><a href="/shop/CID_436.html" title="садовые воздуходувки">(садовые воздуходувки)</a></span></li>';
			$submenuhead.='</ul>';							
			//********************************************************************* 88 ***********************************************************************************					
			//генерация первого раздела меню "по типу"
			//$res=$this->PHPShopOrm->query($sql_1);
