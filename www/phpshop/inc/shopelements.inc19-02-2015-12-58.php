        ...
        if(is_array($data))
            foreach($data as $row) {
				...
				if (strpos($row['name'],"(")===false)
				{
					if ($row['id']==79) {
						//echo $row['id'];
						$this->set('catalogName',$row['name'].'&nbsp<a href="/shop/CID_417.html" title="Пилы цепные электрические">(Пилы цепные электрические)</a>');
						$this->set('width','');
						...
						$dis.=ParseTemplateReturn($this->getValue('templates.podcatalog_forma'));
							...
							//echo $row['id'];
							$this->set('catalogName',$row['name'].'&nbsp<a href="/shop/CID_458.html" title="Мойки высокого давления Karcher">(Мойки высокого давления Karcher)</a>');
		...
		if ($row['id']=='288') {
			...
			foreach ($res1 as $prod_row1) {
				if ($prod_row1[category_id]==1 && $prod_row1[id]==145) {
					...
					$submenuhead1_1.='(<a href="/shop/CID_426.html" style="font-size:12px;" title="Бензиновые ямобуры">Бензиновые ямобуры</a>,&nbsp';
					...
					$submenuhead1_1.='<li><span class="inside_menu_head" style="font-size:12px;width: 99%;"><a href="/shop/CID_'.$prod_row1[id].'.html" title="'.$prod_row1[name].'">'.$prod_row1[name].'</a>&nbsp';
					$submenuhead1_1.='(<a href="/shop/CID_428.html" style="font-size:12px;" title="Бензобуры для рыбалки">Бензобуры для рыбалки</a>,&nbsp';
			...
			$submenuhead.='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Садовые воздуходувы</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';		
			$submenuhead.='<ul>';							
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_292.html" title="техника для благоустройства участка">техника для благоустройства участка</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_88.html" title="садовые воздуходувы">садовые воздуходувы</a><a href="/shop/CID_436.html" title="садовые воздуходувки">(садовые воздуходувки)</a></span></li>';
			$submenuhead.='</ul>';								
			//********************************************************************* 142 ***********************************************************************************					
			//генерация первого раздела меню "по типу"
			//$res=$this->PHPShopOrm->query($sql_1);
