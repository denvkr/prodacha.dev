...
*/
	...
	function custommenuoutput ($row,$i) {
		...
		if ($row['id']=='288') {
			...
			$sql_1="select id,name,case parent_to when 37 then 1 when 44 then 2 when 16 then 3 when 5 then 4 when 36 then 5 end as category_id from `phpshop_categories` where parent_to in (37,44,16,5,36) and name not like '%(%)%' order by num";
			$sql_2="select id,name,case parent_to when 37 then 1 when 44 then 2 when 16 then 3 when 5 then 4 when 36 then 5 end as category_id from `phpshop_categories` where parent_to in (37,44,16,5,36) and name like '%(%)%' order by num";
			...
			$submenuhead.='<ul>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_288.html" title="мотоблоки и культиваторы">мотоблоки и культиваторы</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_44.html" title="мотокультиваторы">мотокультиваторы</a></span></li>';
			$submenuhead.='</ul>';
			//********************************************************************* 44 ***********************************************************************************
			//генерация первого раздела меню "по типу"
			...
			$sql_1="select id,name,case parent_to when 293 then 1 when 88 then 2 when 142 then 3 when 172 then 4 when 224 then 5 end as category_id from `phpshop_categories` where parent_to in (293,88,142,172,224) and name not like '%(%)%' order by num";
			$sql_2="select id,name,case parent_to when 293 then 1 when 88 then 2 when 142 then 3 when 172 then 4 when 224 then 5 end as category_id from `phpshop_categories` where parent_to in (293,88,142,172,224) and name like '%(%)%' order by num";			
			...
			$submenuhead.='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Мотобуры, бензобуры</span>';
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';		
			$submenuhead.='<ul>';							
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_292.html" title="техника для благоустройства участка">техника для благоустройства участка</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_142.html" title="мотобуры, бензобуры">мотобуры, бензобуры</a></span></li>';
			$submenuhead.='</ul>';								
			//********************************************************************* 142 ***********************************************************************************					
			//генерация первого раздела меню "по типу"
			//$res=$this->PHPShopOrm->query($sql_1);
			...
			$submenuhead.='<li onclick="document.getElementById(\'fade\').style.display=\'block\'" onmouseover="this.style.backgroundColor=\'#8ab943\'" onmouseout="this.style.backgroundColor=\'#e5e5e5\'" style="display:none;background: #e5e5e5;height: 24px;"><span>Дровоколы, измельчители</span>';					
			$submenuhead.='<div class="submenuhead">';
			$submenuhead.='<div class="menutype">';
			$submenuhead.='<ul>';							
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_292.html" title="техника для благоустройства участка">техника для благоустройства участка</a></span></li>';
			$submenuhead.='<li><span class="inside_menu_head"><a href="/shop/CID_224.html" title="дровоколы, измельчители">дровоколы, измельчители</a></span></li>';
			$submenuhead.='</ul>';							
			//********************************************************************* 224 ***********************************************************************************					
			//генерация первого раздела меню "по типу"
			//$res=$this->PHPShopOrm->query($sql_1);
