...
*/
	...
	function custommenuoutput ($row,$i) {
		...
		if ($row['id']=='288') {
			...
			$sql_1="select id,name,case parent_to when 37 then 1 when 44 then 2 when 16 then 3 when 5 then 4 when 36 then 5 end as category_id from `phpshop_categories` where parent_to in (37,44,16,5,36) and name not like '%(%)%'";
			...
			$sql_1="select id,name,case parent_to when 18 then 1 when 85 then 2 when 215 then 3 when 297 then 4 when 298 then 5 when 299 then 6 when 254 then 7 when 272 then 8 end as category_id from `phpshop_categories` where parent_to in (18,85,215,297,298,299,254,272) and name not like '%(%)%'";
			...
			$sql_1="select id,name,case parent_to when 293 then 1 when 88 then 2 when 142 then 3 when 172 then 4 when 224 then 5 end as category_id from `phpshop_categories` where parent_to in (293,88,142,172,224) and name not like '%(%)%'";
