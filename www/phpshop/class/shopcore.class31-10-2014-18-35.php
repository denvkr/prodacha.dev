...
class PHPShopShopCore extends PHPShopCore {
    ...
    function setPaginator($count, $sql = null) {
        ...
        if ($this->page==1 || empty($this->page) || ($this->page != 'ALL' && strlen((int) $this->page)!=strlen($this->page)) || ($this->page > $num)) {//preg_match('/^[0-9]{1,3}$/i', $this->page) (($this->page > $this->num_page) && $this->page != 'ALL') {
