    ...
    function checkStore($row = array()) {
        ...
        // Товар под заказ | снят с производства
        	...
        	if (!(empty($row['outdated']))) {
        		...
        		$this->set('price_comlain','<span id="price_comlain'.$row['id'].'" class="price_comlain" style="position:relative;left:-20px;"><noindex>'.$this->lang('outdated_message2').'</noindex></span>'.
